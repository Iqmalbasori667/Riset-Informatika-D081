...
Deep reinforcement learning (DRL) has made great
...
updates the policy to maximize the return with an end-toend method. In this paper, we survey the progress of DRL
...
when applying DRL methods to this field, including explorationexploitation, sample efficiency, generalization and transfer, multiagent learning, imperfect information, and delayed spare rewards, as well as some research directions.